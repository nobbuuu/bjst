...
open class BaseParamBean(
    ...
    val `958484A29186879D9B9A`: String? = BuildConfig.VERSION_NAME,//包版本号，包版本号，如1,2,3,4数字形式，每更新一个版本+1，通过这个来控制包是否升级
    val `959A90869B9D90BD90`: String? = null,//androidId
    val `978187809B999186BD90`: String? = UserManager.getUserNo(),//客户编号,登录之前的接口可为null
