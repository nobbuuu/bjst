package com.kredit.cash.loan.app.common

import androidx.lifecycle.MutableLiveData
import com.blankj.utilcode.util.LogUtils
import com.kredit.cash.loan.app.bean.UserInfo
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_ACCESS_TOKEN
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_ACCOUNTID
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_CUSTOMER_EMAIL
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_CUSTOMER_ID
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_CUSTOMER_UID
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_IS_FALSE_ACCOUNT
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_REFRESH_TOKEN
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_USERNO
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_USER_NAME
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_USER_PHONE
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_VISIBLE_INVITE
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_VISIBLE_MYMONEY
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_VISIBLE_PARTNER
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_VISIBLE_PROFIT
import com.kredit.cash.loan.app.common.MmkvConstant.KEY_VISIBLE_WALLET
...
object UserManager {
    ...
    fun getUserPhone(): String {
        return MmkvUtil.decodeString(getUserPhoneKey()) ?: ""
    }
