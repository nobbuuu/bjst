...
import com.kredit.cash.loan.app.other.toBoolean
...
object Api {
     ...
     * 聊天拼接
     */
    suspend fun chatMessage(): com.kredit.cash.loan.app.account.bean.ChatMessageBean {
        return RxHttp.postJson("/DB979B8691DB958484DB929180979CB78187809B999186B7958691BD9A929B")
            .addAll(GsonUtils.toJson(BaseParamBean()))
            .toResponse<com.kredit.cash.loan.app.account.bean.ChatMessageBean>()
            .await()
     ...
     * 隐私协议
     */
    suspend fun privacyContent(): com.kredit.cash.loan.app.account.bean.PrivacyBean {
        return RxHttp.postJson("/DB979B8691DB958484DB929180979CB59386919199919A80")
            .addAll(GsonUtils.toJson(BaseParamBean()))
            .toResponse<com.kredit.cash.loan.app.account.bean.PrivacyBean>()
            .await()
    ...
    suspend fun fetchProducts(): LoanInfoBean {
        ...
        return RxHttp.postJson("/DB979B8691DB84869B90819780DB929180979CA4869B9081978087")
            .addAll(GsonUtils.toJson(QueryProductBean(com.kredit.cash.loan.app.utils.DeviceUtils.getGlobalIPAddress())))
