...
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.CHANGE_BIND
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.CHANGE_PASSWORD
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.CHECK_ACCOUNT_STATUS
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.CHECK_PHONE_SMS
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.GET_PHONE_SMS
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.JUDGE_PHONE_IS_BANDED
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.LOGIN
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.REGISTERED
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.UPDATE_USER
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.VERIFY_CODE
import com.kredit.cash.loan.app.other.security.EncryptTShopHelper.WX_BIND_PHONE
